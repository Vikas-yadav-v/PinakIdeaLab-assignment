...
/**
 * Improved Hero component with better code organization
 * - Extracted into reusable HeroSection component
 * - Better separation of concerns
 * - More maintainable prop handling
 */
...
/**
 * Separated content section for better maintainability
 */
...
/**
 * Separated CTA buttons for better component organization
 */
function CTAButtons() {
  return (
    <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in-up animation-delay-300">
      ...
      <Link href="/services">
        <Button
          size="lg"
          variant="outline"
          className="group w-full sm:w-auto hover:border-primary transition-all duration-300 hover:shadow-lg bg-transparent"
        >
...
/**
 * Separated image section for better code clarity
 */
